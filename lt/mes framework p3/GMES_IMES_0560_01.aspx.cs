...
* @desc    : 계획관리 - 생산계획 - 자재 투입계획 관리 - 등록/삭제
************************************************************************************************* 
...
public partial class GMES_IMES_0560_01 : GMESPage
{
    ...
    private void ParsingRequest()
    {
        ...
        this.hidLOTID.Value = Request["LOTID"].ToString();
        this.hidSingleInputYNType.Value = Request["SINGLEINPUTYNTYPE"].ToString();
        this.hidSingleDispersionType.Value = Request["SINGLE_DISPERSION_TYPE"].ToString();
    }
